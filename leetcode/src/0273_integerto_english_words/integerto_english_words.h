...
IntegertoEnglishWords::DigitArray IntegertoEnglishWords::intToDigitArray(int num, int &digitCount) {
  DigitArray result;
...
bool IntegertoEnglishWords::convert(std::int8_t hundred, std::int8_t ten, std::int8_t unit,
                       std::string &result) {
