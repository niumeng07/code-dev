...
#include "0018_four_sum/four_sum.h"
...
int main(int argc, char **argv) {
    ...
    cout << "--------------------------------------" << endl;
    vector<int> vec3(
            {-483, -476, -475, -460, -450, -431, -428, -419, -410, -374, -347,
             -345, -311, -303, -299, -286, -278, -271, -260, -257, -240, -227,
             -217, -203, -196, -191, -189, -179, -171, -151, -150, -144, -134,
             -130, -112, -107, -97,  -96,  -94,  -70,  -62,  -54,  -38,  -38,
             -23,  -12,  -11,  -2,   2,    4,    30,   33,   38,   51,   51,
             54,   69,   90,   108,  111,  112,  112,  121,  129,  163,  182,
             184,  194,  198,  199,  210,  228,  229,  232,  236,  237,  249,
             249,  259,  282,  303,  312,  317,  329,  329,  342,  349,  368,
             375,  380,  384,  393,  420,  433,  441,  446,  460,  474,  497});
    ...
    cout << "--------------------------------------" << endl;
    vector<int> vec5({-493, -470, -464, -453, -451, -446, -445, -407, -406,
                      -393, -328, -312, -307, -303, -259, -253, -252, -243,
                      -221, -193, -126, -126, -122, -117, -106, -105, -101,
                      -71,  -20,  -12,  3,    4,    20,   20,   54,   84,
                      98,   111,  148,  149,  152,  171,  175,  176,  211,
                      218,  227,  331,  352,  389,  410,  420,  448,  485});
    ...
    vector<int> vec6(
            {91277418,  66271374,  38763793,  4092006,   11415077,  60468277,
             ...
             -18929014, -73824245});
    vector<vector<int> > result6 = su.fourSum(vec6, -236727523);
    for (auto vec : result6) {
        for (auto x : vec) cout << x << "\t" << ends;
        cout << endl;
    }
    cout << "--------------------------------------" << endl;
    vector<int> vec7({3, 1, 4, 2, 5, -4, 2, 4, -5});
    vector<vector<int> > result7 = su.fourSum(vec7, -12);
    for (auto vec : result7) {
        for (auto x : vec) cout << x << "\t" << ends;
        cout << endl;
    }
    cout << "--------------------------------------" << endl;
    vector<int> vec8(
            {91277418,  66271374,  38763793,  4092006,   11415077,  60468277,
             ...
             30677010,  -21202664, -86235407, 3164123,   8956697,   -9003909,
             -18929014, -73824245});
    vector<vector<int> > result8 = su.fourSum(vec8, -236727523);
    for (auto vec : result8) {
        for (auto x : vec) cout << x << "\t" << ends;
        cout << endl;
    }
    end = clock();
    cout << "all time used: " << end - start << " (best time: 16082)" << endl;
    return 0;
}
// -5, -4, 1, 2, 2, 3, 4, 4, 5
